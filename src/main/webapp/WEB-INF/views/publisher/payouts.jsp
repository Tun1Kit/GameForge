    ...
    <div class="container-xl py-3">
      <div class="d-flex align-items-center justify-content-between gap-3">
        ...
        <a href="${pageContext.request.contextPath}/" class="d-flex align-items-center gap-2 text-decoration-none flex-shrink-0">
          ...
          <span class="fs-5 fw-black fw-bold text-white">
            ...
            <span class="badge ms-1"
                  style="font-size:9px;border-radius:999px;padding:2px 6px;background:var(--gf-yellow);color:#000;">
              PUBLISHER
            </span>
          </span>
        </a>
        ...
        <div class="d-flex align-items-center gap-2 flex-wrap">
          ...
          <a href="${pageContext.request.contextPath}/kyc"
             class="btn btn-sm gf-border-2 gf-shadow-sm gf-press bg-white text-dark fw-bold rounded-3 d-flex align-items-center gap-2 py-2 px-3">
          ...
          <div class="dropdown">
            <button class="btn dropdown-toggle gf-press d-flex align-items-center gap-2"
              ...
              <img src="${not empty currentUser.avatar ? currentUser.avatar : 'https://api.dicebear.com/7.x/pixel-art/svg?seed=Publisher'}"
                   alt="Avatar"
