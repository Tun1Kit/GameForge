    ...
    <div class="container-xl py-3">
      <div class="d-flex align-items-center justify-content-between gap-3">
        ...
        <div class="d-flex align-items-center gap-2 gap-sm-3">
          ...
          <a href="${pageContext.request.contextPath}/library" class="btn gf-border-2 gf-shadow-sm gf-press bg-white text-dark fw-bold rounded-3 d-flex align-items-center gap-2 py-2 px-3">
