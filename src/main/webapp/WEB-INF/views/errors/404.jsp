...
<head>
    <meta charset="UTF-8">
    <title>GameForge - Không tìm thấy trang</title>
    ...
    <style>
        body {
            min-height: 100vh;
            background:
                radial-gradient(circle at 15% 20%, rgba(46, 204, 113, .2), transparent 28%),
        ...
        <div class="row align-items-center g-4">
            <div class="col-lg-4 text-center">
                <div class="error-icon mx-auto mb-4">
                    <i data-lucide="ghost" width="42" height="42"></i>
                </div>
            ...
            <div class="col-lg-8">
                <h1 class="error-title mb-3">
                    Không tìm thấy<br>
                    <span style="color:var(--gf-green);text-shadow:3px 3px 0 #000;">trang này!</span>
                </h1>

                <p class="fs-5 fw-semibold text-secondary mb-4">
                    Đường dẫn bạn truy cập không tồn tại hoặc game này chưa được đăng trên GameForge.
                </p>
