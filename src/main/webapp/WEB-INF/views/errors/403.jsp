...
<head>
    <meta charset="UTF-8">
    <title>GameForge - Không có quyền truy cập</title>
    ...
    <style>
        body {
            min-height: 100vh;
            background:
                radial-gradient(circle at 15% 20%, rgba(248, 113, 113, .2), transparent 28%),
        ...
        <div class="row align-items-center g-4">
            ...
            <div class="col-lg-8">
                ...
                <p class="fs-5 fw-semibold text-secondary mb-4">
                    Tài khoản của bạn không được phân quyền để truy cập vào tài nguyên này. Vui lòng kiểm tra lại.
                </p>
